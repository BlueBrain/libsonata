...
class IoWriter {
  public:
    IoWriter(const std::string& report_name): m_report_name(report_name) {}
    ...
    virtual void configure_attribute(const std::string& group_name, const std::string& attribute_name, const std::string& attribute_value) {}
    virtual void configure_dataset(const std::string& dataset_name, int total_steps, int total_elements) {}
    virtual void write(const std::vector<double>& buffer, int steps_to_write, int total_steps, int total_elements) = 0;
